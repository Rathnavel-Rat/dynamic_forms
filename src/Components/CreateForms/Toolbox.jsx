...
const styledDrag=(isDragging,prestyle)=>({
    ...
    borderRadius: "3px",
    background: `#f1e8e8`,
    border: `2px ${(isDragging ? 'dashed #333' : 'solid #ed58e8')}`,
    ...prestyle,
});
...
const getRenderItem = (items) => (provided, snapshot, rubric) => {
    ...
    return (
      <React.Fragment>
        <div {...provided.draggableProps}{...provided.dragHandleProps} ref={provided.innerRef} style={styledDrag(snapshot.isDragging, provided.draggableProps.style)}>
         <List.Content>
